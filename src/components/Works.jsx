      ...
      <Tilt options={{
        ...
        >
          <div className="relative w-full h-[230px]">
            ...
            <img src={image} alt={name} className="w-full h-[80%] object-fill rounded-2xl" />
    ...
    <motion.div
      ...
      <div className="w-full flex">
        ...
        >
          ...
          reral-world examples of my works. Each project is briefly described with 
          links to code repositories and live
          demos in it. It reflects my 
          ability to solve complex problems, workwith different technologies,
